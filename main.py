...
def main():
    training_set = AsrDataset(
        ...
        feature_file='/Users/hirtikamirghani/Downloads/data (1)-1 2/clsp.trnlbls',
        feature_label_file='/Users/hirtikamirghani/Downloads/data (1)-1 2/clsp.lblnames',
    ...
    test_set = AsrDataset(
        feature_label_file='/Users/hirtikamirghani/Downloads/data (1)-1 2/clsp.devlbls',
        wav_scp='/Users/hirtikamirghani/Downloads/data (1)-1 2/clsp.devwav',
        wav_dir='/Users/hirtikamirghani/Downloads/data (1)-1 2/waveforms'
    )

    print(f"Number of scripts loaded: {len(training_set.script)}")
    print(f"Number of features loaded: {len(training_set.features)}")
    print(f"Number of scripts loaded: {len(test_set.script)}")
    print(f"Number of features loaded: {len(test_set.features)}")
    ...
    model = LSTM_ASR(feature_type='discrete', input_size=len(label_names) + 1, hidden_size=256, num_layers=2,
